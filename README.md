...
SillyTavern 채팅 편의 기능 확장입니다.

## 통합 명령어

`/st` 뒤에 원하는 기능 이름을 입력해서 SlashTavern 기능을 실행할 수 있습니다.

| 명령어 | 기능 |
|---|---|
| `/st search` | 검색 패널 열기 |
| `/st search 키워드` | 채팅에서 키워드 검색 |
| `/st search 원본/바꿀말` | 찾아바꾸기 |
...
| `/st messages` | 메시지 도구 통합 패널 열기 |
| `/st edit` | 전체 메시지 관리 패널 열기 |
